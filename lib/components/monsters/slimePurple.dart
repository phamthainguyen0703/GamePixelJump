...
class SlimePurple extends SpriteAnimationGroupComponent
  ...
  SlimePurple({this.offNeg = 0, this.offPos = 0, super.position, super.size});
  ...
  SpriteAnimation _spriteAnimation(String state, int amount) {
    return SpriteAnimation.fromFrameData(
        game.images.fromCache('Monsters/SlimePurple/$state.png'),
