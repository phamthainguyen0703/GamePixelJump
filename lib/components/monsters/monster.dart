...
class Monster extends SpriteAnimationGroupComponent
  ...
  Monster({this.offNeg = 0, this.offPos = 0, super.position, super.size});
  ...
  FutureOr<void> onLoad() {
    ...
    _loadAllAnimations();
    _calculateRange();
    add(RectangleHitbox(position: Vector2(2, 2), size: Vector2(12, 14)));
    return super.onLoad();
  }
  ...
  void _loadAllAnimations() {
    _idleAnimation = _spriteAnimation('Idle2', 4);
    _runningAnimation = _spriteAnimation('Running2', 6);
    _stompedAnimation = _spriteAnimation('Stomped', 4);
  ...
  SpriteAnimation _spriteAnimation(String state, int amount) {
    return SpriteAnimation.fromFrameData(
        game.images.fromCache('Monsters/Octopus/$state.png'),
